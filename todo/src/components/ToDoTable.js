...
function ToDoTable() {
  ...
  const [showDuplicateWarning, setShowDuplicateWarning] = useState(false);//Benji
  const [sortOrder, setSortOrder] = useState('asc');//Huni
  ...
  const sortedTodos = sortTodos(todos, sortOrder);//Huni
